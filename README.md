...
| ✉️ Email | estudiosivality@gmail.com |
...
## 📱 Contacto & Redes Sociales en el sitio

El footer incluye los siguientes íconos de redes sociales con tooltips:
...
```bash
# Con cualquier servidor local para desarrollo:
npx serve .
# o
python -m http.server 8080
```

Compatible con: **Netlify**, **Vercel**, **GitHub Pages**, **cPanel**, **cualquier hosting compartido**.
